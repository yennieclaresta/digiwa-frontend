    ...
    sections: [
      {
        ...
        fields: [
          ...
          { name: 'tanggalLahirAnak', label: 'Tanggal Lahir', required: true, validation: 'date', type: 'date', placeholder: 'YYYY-MM-DD' },
          { name: 'waktuLahir', label: 'Waktu Lahir', required: true, type: 'time', placeholder: 'HH:mm' },
      ...
      },
      {
        ...
        fields: [
          ...
          { name: 'tanggalLahirAyah', label: 'Tanggal Lahir Ayah', required: true, validation: 'date', type: 'date', placeholder: 'YYYY-MM-DD' },
      ...
      },
      {
        ...
        fields: [
          ...
          { name: 'tanggalLahirIbu', label: 'Tanggal Lahir Ibu', required: true, validation: 'date', type: 'date', placeholder: 'YYYY-MM-DD' },
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        title: 'Data Kematian',
        fields: [
          { name: 'tanggalMeninggal', label: 'Tanggal Meninggal', required: true, validation: 'date', type: 'date', placeholder: 'YYYY-MM-DD' },
          { name: 'waktuMeninggal', label: 'Waktu Meninggal', required: true, type: 'time', placeholder: 'HH:mm' },
